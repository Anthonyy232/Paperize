                        ...
                        Slider(
                            ...
                            onValueChange = {
                                ...
                                job = scope.launch {
                                    delay(500)
                                    if (bothEnabled) {
                                        onVignettePercentageChange(it.roundToInt(), lockPercentage.roundToInt())
                                    } else {
                                        onVignettePercentageChange(it.roundToInt(), it.roundToInt())
                                    }
                                }
                            },
                            valueRange = 0f..100f,
                        ...
                        if (bothEnabled) {
                            ...
                            Slider(
                                ...
                                onValueChange = {
                                    ...
                                    job = scope.launch {
                                        delay(500)
                                        onVignettePercentageChange(homePercentage.roundToInt(), it.roundToInt())
                                    }
                                },
                                valueRange = 0f..100f,
                                steps = 100,
