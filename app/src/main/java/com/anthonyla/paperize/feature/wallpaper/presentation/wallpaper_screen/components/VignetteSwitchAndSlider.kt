...
/**
 * Composable that displays a switch and slider for the vignette effect
 */
@Composable
fun VignetteSwitchAndSlider(
    ...
    var homePercentage by rememberSaveable { mutableFloatStateOf(homeVignettePercentage.toFloat()) }
    var lockPercentage by rememberSaveable { mutableFloatStateOf(lockVignettePercentage.toFloat()) }
        ...
        Column(
            ...
            Row(
                ...
                Column(
                    ...
                    Text(
                        text = stringResource(R.string.change_vignette),
                        style = MaterialTheme.typography.titleMedium,
                        fontWeight = FontWeight.W500
                    )
                    if (!vignette) {
                        Text(
                            text = stringResource(R.string.darken_the_edges_of_the_image),
                        ...
                        if (bothEnabled) {
                            ...
                            Slider(
                                ...
                                onValueChange = { value ->
                                    ...
                                    job = scope.launch {
                                        delay(100)
                                        onVignettePercentageChange(value.roundToInt(), lockPercentage.roundToInt())
                                    }
                                },
                                valueRange = 0f..100f,
                                steps = 100,
                            ...
                            Slider(
                                ...
                                onValueChange = { value ->
                                    ...
                                    job = scope.launch {
                                        delay(100)
                                        onVignettePercentageChange(homePercentage.roundToInt(), value.roundToInt())
                                    }
                                },
                                valueRange = 0f..100f,
                                steps = 100,
