...
dependencies {
    ...
    implementation("androidx.compose.ui:ui-tooling-preview:1.7.0-alpha07")
    ...
    androidTestImplementation("androidx.compose.ui:ui-test-junit4:1.7.0-alpha07")
    debugImplementation("androidx.compose.ui:ui-tooling:1.7.0-alpha07")
